...
export default function AdminDashboard() {
  ...
  const logoUrl = logoData?.storage_path
    ? api.getLogoUrl(logoData.storage_path)
    : null;
  ...
  const handleCrop = (cropperInstance: Cropper) => {
            ...
            <>
              {activeTab === "dashboard" && (
                <div className="grid gap-4">
                  {/* Logo Section */}
                  {/* Replace the logo section in your dashboard tab */}
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                      ...
                      <div className="relative">
                        {logoUrl ? (
                          <img
                            ...
                            alt="Profile Logo"
                            onError={(e) => {
                              e.currentTarget.src = ""; // Clear the errored image
                      ...
                      <div className="space-y-4">
                          ...
                          <div className="relative">
                            <Cropper
                              ...
                              onInitialized={(instance) => {
                                cropperRef.current = instance; // Only set the ref
                              }}
                            />

                            <div className="flex gap-2 mt-4">
                              <button
                                onClick={() => cropperRef.current?.rotate(-45)}
                        ...
                        <div className="flex justify-end gap-4 mt-6">
                          ...
                          <button
                            ...
                            disabled={!preview || uploadLogoMutation.isPending}
                          >
